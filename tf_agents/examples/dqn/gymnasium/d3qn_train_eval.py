...
python tf_agents/examples/dqn/gymnasium/d3qn_train_eval.py --root_dir=$HOME/tmp/d3qn_lunar_lander
```
...
from tf_agents.networks import q_network, dueling_q_network
...
def train_eval(
  ...
  eval_env = suite_gym.load(env_name, max_episode_steps=400, render_kwargs={"render_mode": "rgb_array"})
